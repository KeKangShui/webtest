...
<script type="text/javascript">
    function updateSku(sku) {
        //让输入框亮起来
		//市场价
		$("#m"+sku).attr("disabled",false);
        //售价
        $("#p"+sku).attr("disabled",false);
        //库存
        $("#i"+sku).attr("disabled",false);
        //限制
        $("#l"+sku).attr("disabled",false);
        //运费
        $("#f"+sku).attr("disabled",false);
    }
    function addSku(skuId) {
        ...
        //保存
		url = "/sku/add.do";
		params = {"marketPrice":m,"skuPrice":p,"stockInventory":i,"skuUpperLimit":l,"deliveFee":f,"id":skuId};
