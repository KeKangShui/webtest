package cn.biye.core.service.user;

import java.util.List;

import javax.annotation.Resource;

import cn.biye.core.bean.user.Employee;
import cn.biye.core.dao.user.EmployeeDao;
import cn.biye.core.query.user.EmployeeQuery;
